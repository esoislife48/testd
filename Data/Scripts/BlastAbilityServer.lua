--[[
	...
	v1.2-b
	by: standardcombo
	blast ability = slimychiken
	
	Handles melee combat interaction of attack abilities on weapons such as swords.
--]]

local HammerBlastImpact = script:GetCustomProperty("HammerBlastImpact")
...
function OnExecute(ability)
	...
	-- spawns blast
	local blastTemplate = World.SpawnAsset(HammerBlastImpact, {position = ability.owner:GetWorldPosition()})
