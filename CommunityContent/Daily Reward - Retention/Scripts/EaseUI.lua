...
-- Version 1.0.0, Updated August 29, 2020
...
local function verifyEase(uiElement, goal, easeDuration, easingEquation, easingDirection)
	if(not uiElement:IsA("UIControl")) then
		return false, "Attempting to ease the position of a object that is not a UI Element"
	elseif(uiElement:IsA("UIContainer")) then
		return false, "Attempting to ease the position of a UIContainer"
